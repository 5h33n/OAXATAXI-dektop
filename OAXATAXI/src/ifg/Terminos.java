 ...
 * @author David de Jesús Ramírez Arellano
 *
 */
public class Terminos extends JFrame implements ActionListener, ChangeListener {
	...
	public Terminos() {
		...
		etiquetaTerminos = new JLabel("T�RMINOS Y CONDICIONES");
		...
		areaTerminos.setText("\n\n          TÉRMINOS Y CONDICIONES"
				...
				+ "\n\n            Solo recopilar información personal para procesamiento y uso en el sistema,"
				...
				+ "\n           las medidas de precaución para proteger su información en contra de pórdida, abuso o cambios."
				+ "\n          ");
